...
public class MainActivity2 extends AppCompatActivity {
        ...
        btnbus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(txtid.getText().toString().trim().isEmpty()){
                    ocultarTeclado();
                    Toast.makeText(MainActivity2.this, "Digite El ID del Luchador a Buscar!!", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    dbref.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if(res == false){
                                ocultarTeclado();
                                Toast.makeText(MainActivity2.this, "ID ("+aux+") No Encontrado!!", Toast.LENGTH_SHORT).show();
                            }
        ...
        btnmod.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(txtid.getText().toString().trim().isEmpty()
                    ...
                    ocultarTeclado();
                    Toast.makeText(MainActivity2.this, "Complete Los Campos Faltantes Para Actualizar!!", Toast.LENGTH_SHORT).show();
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            for(DataSnapshot x : snapshot.getChildren()){
                                if(x.child("nombre").getValue().toString().equalsIgnoreCase(nom)){
                                    res2 = true;
                                    ocultarTeclado();
                                    Toast.makeText(MainActivity2.this, "El Nombre ("+nom+") Ya Existe.\nImposible Modificar!!", Toast.LENGTH_SHORT).show();
                                    break;
                                }
                            }
                            ...
                            if(res2 == false){
                                ...
                                if(res == false){
                                    ocultarTeclado();
                                    Toast.makeText(MainActivity2.this, "ID ("+aux+") No Encontrado.\nImposible Modificar!!!!", Toast.LENGTH_SHORT).show();
                                    txtid.setText("");
                                    txtnom.setText("");
                                }
                            }
        ...
        btnreg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(txtid.getText().toString().trim().isEmpty()
                    ...
                    ocultarTeclado();
                    Toast.makeText(MainActivity2.this, "Complete Los Campos Faltantes!!", Toast.LENGTH_SHORT).show();
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            for(DataSnapshot x : snapshot.getChildren()){
                                if(x.child("id").getValue().toString().equalsIgnoreCase(aux)){
                                    res = true;
                                    ocultarTeclado();
                                    Toast.makeText(MainActivity2.this, "Error. El ID ("+aux+") Ya Existe!!", Toast.LENGTH_SHORT).show();
                                    break;
                                }
                            }
                            ...
                            for(DataSnapshot x : snapshot.getChildren()){
                                if(x.child("nombre").getValue().toString().equalsIgnoreCase(nom)){
                                    res2 = true;
                                    ocultarTeclado();
                                    Toast.makeText(MainActivity2.this, "Error. El Nombre ("+nom+") Ya Existe!!", Toast.LENGTH_SHORT).show();
                                    break;
                                }
                            }
                            ...
                            if(res == false && res2 == false){
                                ...
                                ocultarTeclado();
                                Toast.makeText(MainActivity2.this, "Luchador Registrado Correctamente!!", Toast.LENGTH_SHORT).show();
                                txtid.setText("");
                                txtnom.setText("");
                            }
    ...
    private void listarLuchadores(){
        ...
        ArrayAdapter <Luchador> ada = new ArrayAdapter <Luchador> (MainActivity2.this, android.R.layout.simple_list_item_1, lisluc);
    ...
    private void botonEliminar(){
        btneli.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(txtid.getText().toString().trim().isEmpty()){
                    ocultarTeclado();
                    Toast.makeText(MainActivity2.this, "Digite El ID del Luchador a Eliminar!!", Toast.LENGTH_SHORT).show();
                }else{
